...
export default function FreezeFrameModal({ visible, onClose, sendCommand, hasDtcs }: Props) {
 ...
 {/* Description */}
 <Text style={[sDyn.infoTitle, { color: colors.cyan, fontFamily: MONO }]}> {t('freeze.snapshot')}</Text>
 ...
 >
 <Text style={[sDyn.actionBtnText, { color: colors.card, fontFamily: MONO }]}> {t('freeze.read')}</Text>
 </TouchableOpacity>
 )}
