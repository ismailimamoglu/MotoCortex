...
export default function CustomizeDashboardModal({ visible, onClose, onOpenPaywall }: CustomizeDashboardModalProps) {
 ...
 <View style={{ backgroundColor: `${colors.purple}18`, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 }}>
 <Text style={{ color: colors.purple, fontSize: scaleFont(11), fontWeight: '800' }}>
 {t('dashboard.selectedSensorsCount', { count: draftSensors.length, max: maxLimit, defaultValue: `${draftSensors.length} / ${maxLimit} Seçildi` })}
 </Text>
 </View>
 </View>
 <Text style={[sDyn.subtitle, { color: colors.textSec, marginTop: 4 }]}>
 {isKLineProtocol 
 ...
 <View style={[sDyn.layoutRow, { backgroundColor: `${colors.purple}08`, borderColor: `${colors.purple}30`, borderWidth: 1, borderRadius: 12, padding: scaleMod(8), marginVertical: scaleHeight(8) }]}>
 <Text style={[sDyn.layoutLabel, { color: colors.textPri, fontSize: scaleFont(11), fontWeight: '800' }]}>{t('dashboard.layoutType')}</Text>
