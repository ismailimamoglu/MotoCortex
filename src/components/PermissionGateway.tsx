...
const LANGUAGES = [
  { code: 'ar', label: 'العربية', sub: 'Arabic Diagnostics Hub', emoji: '🇸🇦' },
  { code: 'cs', label: 'Čeština', sub: 'Czech Diagnostics Hub', emoji: '🇨🇿' },
  { code: 'da', label: 'Dansk', sub: 'Danish Diagnostics Hub', emoji: '🇩🇰' },
  { code: 'de', label: 'Deutsch', sub: 'German Diagnostics Hub', emoji: '🇩🇪' },
  { code: 'el', label: 'Ελληνικά', sub: 'Greek Diagnostics Hub', emoji: '🇬🇷' },
  { code: 'en', label: 'English', sub: 'English Diagnostics Hub', emoji: '🇬🇧' },
  { code: 'es', label: 'Español', sub: 'Spanish Diagnostics Hub', emoji: '🇪🇸' },
  { code: 'fi', label: 'Suomi', sub: 'Finnish Diagnostics Hub', emoji: '🇫🇮' },
  { code: 'fr', label: 'Français', sub: 'French Diagnostics Hub', emoji: '🇫🇷' },
  { code: 'hi', label: 'हिन्दी', sub: 'Hindi Diagnostics Hub', emoji: '🇮🇳' },
  { code: 'hu', label: 'Magyar', sub: 'Hungarian Diagnostics Hub', emoji: '🇭🇺' },
  { code: 'id', label: 'Bahasa Indonesia', sub: 'Indonesian Diagnostics Hub', emoji: '🇮🇩' },
  { code: 'it', label: 'Italiano', sub: 'Italian Diagnostics Hub', emoji: '🇮🇹' },
  { code: 'ja', label: '日本語', sub: 'Japanese Diagnostics Hub', emoji: '🇯🇵' },
  { code: 'ko', label: '한국어', sub: 'Korean Diagnostics Hub', emoji: '🇰🇷' },
  { code: 'nl', label: 'Nederlands', sub: 'Dutch Diagnostics Hub', emoji: '🇳🇱' },
  { code: 'no', label: 'Norsk', sub: 'Norwegian Diagnostics Hub', emoji: '🇳🇴' },
  { code: 'pl', label: 'Polski', sub: 'Polish Diagnostics Hub', emoji: '🇵🇱' },
  { code: 'pt', label: 'Português', sub: 'Portuguese Diagnostics Hub', emoji: '🇵🇹' },
  { code: 'ro', label: 'Română', sub: 'Romanian Diagnostics Hub', emoji: '🇷🇴' },
  { code: 'ru', label: 'Русский', sub: 'Russian Diagnostics Hub', emoji: '🇷🇺' },
  { code: 'sv', label: 'Svenska', sub: 'Swedish Diagnostics Hub', emoji: '🇸🇪' },
  { code: 'th', label: 'ไทย', sub: 'Thai Diagnostics Hub', emoji: '🇹🇭' },
  { code: 'tr', label: 'Türkçe', sub: 'Türkçe Teşhis Arayüzü', emoji: '🇹🇷' },
  { code: 'uk', label: 'Українська', sub: 'Ukrainian Diagnostics Hub', emoji: '🇺🇦' },
  { code: 'zh', label: '中文', sub: 'Chinese Diagnostics Hub', emoji: '🇨🇳' }
];
