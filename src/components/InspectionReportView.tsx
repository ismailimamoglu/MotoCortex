...
export default function InspectionReportView({ visible, onClose, report }: InspectionReportViewProps) {
 ...
 <Text style={{ color: colors.textPri, fontSize: scaleFont(16), fontWeight: '900' }}>✕</Text>
 </TouchableOpacity>
 </View>
 ...
 <Text style={[styles.infoLine, { color: colors.textPri }]}>DRIVE SAFETY: {report.summary.isSafeToDrive ? ' SAFE' : ' ATTENTION REQUIRED'}</Text>
 </View>
